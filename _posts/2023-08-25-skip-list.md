...
Estudando mais sobre, realmente pareceu simples, aí pensei: será que consigo implementar? Ao menos falando das mais básicas, sempre achei gostosinho implementar estrutura de dados: são problemas bem definidos, sem dependências externas e normalmente são soluções elegantes.
...
Em São Paulo temos a Linha 11 da CPTM, que é paralela a Linha 3 do metrô, mas com menos paradas. Usando a linha 11, se alguém quiser ir do Brás e para Corinthians-Itaquera, será apenas uma parada no Tatuapé. Usando a Linha 3, serão feitas nove paradas.
